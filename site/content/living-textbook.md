...
**Systems track.** Apple Silicon laboratory. Students build, tick, and certificate-read HELUT from `REPRODUCE.md`. Labs [2](#ch:lab){reference-type="ref" reference="ch:lab"} assume this track.
